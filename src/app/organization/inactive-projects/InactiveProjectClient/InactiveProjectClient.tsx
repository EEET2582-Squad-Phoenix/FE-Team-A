...
import { fetchDeletedProjects, recoverProject } from "@/app/api/charities/charitiesAPI";
...
export default function ProjectClient() {
  ...
  const handleRevertProject = async () => {
    ...
    try {
      ...
      toast.success(`Project "${selectedProject.name}" successfully recovered!`);
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center mb-10">
        <div className="text-gray-900">
          ...
          <p className="text-sm text-gray-600">View projects you have deleted</p>
        </div>
      </div>
      ...
      {projects.length === 0 ? (
        <div className="text-center text-gray-500">
          ...
          <p className="text-sm">Projects you delete will appear here for recovery.</p>
        </div>
      ) : (
